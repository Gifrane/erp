                    ...
                    <template v-for="t in tags">
                        <div class="menu-list-selectable-item" :key="t.id" v-if="!search || regexSearch(t.name)">
                            <div class="selectable-item-checkbox">
                                <input type="checkbox" v-model="$parent.contact.tags" :value="t.id"
...
export default {
    ...
    data: function () {
        return {
            dropdownId: 'dropdown-update-contact-tags',
    ...
    methods: {
        ...
        deleteSelection: function (id) {
            ...
            this.$parent.contact.tags = this.$parent.contact.tags.filter((t) => t != id)
        },
        ...
        refreshTags: function () {
            ...
            for (let t of this.$parent.contact.tags) {
