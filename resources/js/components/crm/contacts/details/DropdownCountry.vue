...
export default {
    ...
    data: function () {
        return {
            dropdownId: 'dropdown-update-contact-country',
    ...
    computed: {
        country: function () { return this.$parent.contact.i18n_country_id }
    },
    created: function () {
    ...
    methods: {
        refreshCountry: function () {
            for (let c of this.countries) {
                if (c.id === this.$parent.contact.i18n_country_id) {
        ...
        select: function (c) {
            ...
            this.$parent.contact.i18n_country_id = c.id
