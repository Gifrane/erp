    ...
    <div class="sidebar-wrapper" v-if="$parent.visibleAdd">
        <div class="sidebar" role="complementary" v-click-outside="outside">
            <div class="sidebar-header">
                <div class="sh-title">{{ $t('pages.crm_companies.add_company') }}</div>
            ...
            <div class="sidebar-body">
                <div class="grid mt-3">
                    <div class="col-4">{{ $t('pages.crm_companies.company_name') }}</div>
                ...
                <button class="btn btn-success" @click="addCompany()">
...
import DropdownCountry from './add_company/DropdownCountry.vue'

export default {
    components: { DropdownCountry },
    directives: { clickOutside: vClickOutside.directive },
    data: function () {
        return {
            add: { name: null, country: null }
        }
    },
    methods: {
        addCompany: function () {
            axios.post('/crm/companies/add', this.add)
                .then((res) => {
                    this.$router.push('/crm/companies/'+res.data.data)
                })
                .catch((e) => {
