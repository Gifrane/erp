<template>
    <div class="contacts">
        <div class="tabs">
            <router-link :to="'/crm/companies/'+companyId">{{ $t('details') }}</router-link>
            <router-link :to="'/crm/companies/'+companyId+'/contacts'" class="active">{{ $t('pages.crm_companies_details.contacts') }}</router-link>
        </div>
...
export default {
    ...
    methods: {
        ...
        getContacts: function () {
            let filters = [
                { filter: 'company', operator: 'is_in', value: [ this.companyId ] }
            ]
...
@import '../../../../sass/vuejs/crm/companies/contacts.sass'
</style>