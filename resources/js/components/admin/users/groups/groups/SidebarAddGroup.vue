    ...
    <div class="sidebar-wrapper" v-if="$parent.visibleAdd">
        <div class="sidebar" role="complementary" v-click-outside="outside">
            <div class="sidebar-header">
                <div class="sh-title">{{ $t('pages.admin_users_groups.add_group') }}</div>
            ...
            <div class="sidebar-body">
                <div class="grid mt-3">
                    ...
                    <div class="col-8"><input type="text" v-model="add.name" class="input w-100" @keyup.enter="addGroup()" /></div>
                </div>
...
export default {
    ...
    methods: {
        addGroup: function () {
            axios.post('/admin/users/groups/add', this.add)
                .then((res) => {
                    this.$router.push('/admin/users/groups/'+res.data.data)
                })
                .catch((e) => {
