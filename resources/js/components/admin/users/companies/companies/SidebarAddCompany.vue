    ...
    <div class="sidebar-wrapper" v-if="$parent.visibleAdd">
        <div class="sidebar" role="complementary" v-click-outside="outside">
            <div class="sidebar-header">
                <div class="sh-title">{{ $t('pages.admin_users_companies.add_company') }}</div>
            ...
            <div class="sidebar-body">
                <div class="grid mt-3">
                    ...
                    <div class="col-8"><input type="text" v-model="add.name" class="input w-100" @keyup.enter="addCompany()" /></div>
                </div>
...
export default {
    ...
    methods: {
        addCompany: function () {
            axios.post('/admin/users/companies/add', this.add)
                .then((res) => {
                    this.$router.push('/admin/users/companies/'+res.data.data)
                })
                .catch((e) => {
